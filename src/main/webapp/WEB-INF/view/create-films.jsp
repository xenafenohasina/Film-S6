...
<div class="container">
    ...
    <div class="cs-prifile_wrap">
        ...
        <div class="cs-profile_right">
            ...
            <h2 class="cs-section_heading cs-style1">Ajouter un film</h2>
            <div class="cs-height_25 cs-height_lg_25"></div>
            <form class="row" action="<%= request.getContextPath() %>/save-films" method="post" enctype="multipart/form-data">

                <div class="row">
                    <div class="col-lg-6">
                        <div class="cs-form_field_wrap">
                            <input type="text" name="nom" class="cs-form_field cs-white_bg" placeholder="Nom...">
                        </div>
                        <div class="cs-height_25 cs-height_lg_25"></div>
                        <div class="cs-form_field_wrap">
                            <input type="file" name="files" class="cs-form_field cs-white_bg">
                        </div>
                        <div class="cs-height_25 cs-height_lg_25"></div>
                        <div>
                            Personnage <button class="btn btn-primary" onClick="ajouter()">Ajouter ++</button>
                        </div>
                        <div class="cs-height_25 cs-height_lg_25"></div>
                    </div>
                </div>

                <div class="row" id="volou">
                </div>

                <div class="row">
                    <div class="cs-height_25 cs-height_lg_25"></div>
                    <div class="col-lg-6">
                        <input type="submit" class="cs-btn cs-style1 cs-btn_lg" value="Enregistrer">
                    </div>
                </div>
...
<script>
    ...
    function ajouter(){
        ...
        e.setAttribute("name","noms");
        e.setAttribute("placeholder","nom");
        e.setAttribute("required","");
        e.setAttribute("type", "text");
        e.setAttribute("class","cs-form_field cs-white_bg");
        ...
        //document.getElementById("volou").appendChild(div);

        t = document.createElement("textarea");
        t.setAttribute("name","descriptions");
        t.setAttribute("placeholder","descriptions");
        t.setAttribute("required","");
        t.setAttribute("class","cs-form_field cs-white_bg");

        div1 = document.createElement("div");
        div1.setAttribute("class","col-lg-6");
        div1.appendChild(t);
        //document.getElementById("volou").appendChild(div1);

        e = document.createElement("div");
        e.setAttribute("class","cs-height_25 cs-height_lg_25");
        ...
        document.getElementById("volou").appendChild(row);
