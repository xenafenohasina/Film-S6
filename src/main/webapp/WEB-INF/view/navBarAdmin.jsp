...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%
   ...
   // List<Etat> etats = (List<Etat>) request.getAttribute("etats");
    Object idAdmin = session.getAttribute("idAdmins");
  %>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link href="${pageContext.request.contextPath}/resources/theme/assets/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
...
<body>
          ...
          <div class="collapse navbar-collapse justify-content-between">
            <div class="header-left">
              <div class="dashboard_bar">
                Gestion de nouveautés
              </div>
            </div>
            <ul class="navbar-nav header-right">
              <form action="<%= request.getContextPath() %>/admin-recherche" method="post">
                <li class="nav-item">
                  <div class="input-group">
                    <select name="idEtat" class="form-control" tabindex="0">
                      <option value="0">Etat</option>
                      <% for(Etat e:etats){ %>
                        <option value="<%= e.getIdEtat() %>"><%= e.getEtat() %></option>
                      <% } %>
                    </select>
                    <input type="text" id="mot" name="mot" class="form-control wide" tabindex="0" placeholder="Rechercher ici...">
  ...
  <div class="nav-header">
    <a class="brand-logo">
      <img width="200px" height="50px" src="${pageContext.request.contextPath}/resources/theme/logo/logo3.png" alt="">
    </a>
      ...
      <ul class="metismenu" id="menu">
        <li class="dropdown header-profile">
          <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
            <img src="${pageContext.request.contextPath}/resources/theme/assets/images/profile/3.jpg" width="20" alt=""/>
            <div class="header-info ms-3">
              <span class="font-w600 "><b><%= user.getNom() %></b></span>
              <small class="text-end font-w400"><%= user.getEmail() %></small>
            </div>
          </a>
          <div class="dropdown-menu dropdown-menu-end">
            <a href="<%= request.getContextPath() %>/deconnexion-admin" class="dropdown-item ai-icon">
        ...
        <li>
          <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
            ...
            <span class="nav-text">Actualité</span>
          </a>
          <ul aria-expanded="false">
            <% if(idAdmin == null){ %>
              <li><a href="<%= request.getContextPath() %>/liste-contenue?pageId=1">Mes publications</a></li>
              <li><a href="<%= request.getContextPath() %>/form-contenue">Insertion</a></li>
            <% }else{ %>
              <li><a href="<%= request.getContextPath() %>/liste-contenue?pageId=1">Liste</a></li>
              <li><a href="<%= request.getContextPath() %>/form-nombre">Affichage</a></li>
            <% } %>
          </ul>
        </li>
      </ul>
  ...
  <script src="${pageContext.request.contextPath}/resources/theme/assets/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
  ...
  <script src="${pageContext.request.contextPath}/resources/theme/assets/js/demo.js"></script>
  <script src="${pageContext.request.contextPath}/resources/theme/assets/js/styleSwitcher.js"></script>
  <script src="${pageContext.request.contextPath}/resources/theme/assets/js/monScript.js"></script>
  <script src="${pageContext.request.contextPath}/resources/theme/assets/js/jquery-3.6.0.js"></script>
</body>

<!-- Mirrored from dompet.dexignlab.com/xhtml/empty-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Sep 2022 10:36:38 GMT -->
</html>